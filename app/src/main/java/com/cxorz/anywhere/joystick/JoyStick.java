...
public class JoyStick extends View {
    private static final int DivGo = 1000;    /* Movement time interval, in ms */
    ...
    private double mSpeed = 1.2;        /* Default speed, in m/s */
    ...
    private void initWindowManager() {
        ...
        mWindowParamCurrent.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE      // Not adding this will prevent game from starting (MIUI12), adding it prevents keyboard from showing
    ...
    private void initJoyStickView() {
        ...
        mTimer.setListener(new GoUtils.TimeCount.TimeCountListener() {
            ...
            public void onFinish() {
                // Note: correspondence between x, y and angle in circle (positive X-axis is 0 degrees) and conversion to km
                disLng = mSpeed * (double)(DivGo / 1000) * mR * Math.cos(mAngle * 2 * Math.PI / 360) / 1000;// Note: Android trigonometric functions use radians
                disLat = mSpeed * (double)(DivGo / 1000) * mR * Math.sin(mAngle * 2 * Math.PI / 360) / 1000;// Note: Android trigonometric functions use radians
                mListener.onMoveInfo(mSpeed, disLng, disLat, 90.0F-mAngle);
                mTimer.start();
            }
        });
        // Get speed setting from preferences
        try {
        ...
        /* Entire joystick drag event handling */
        mJoystickLayout.setOnTouchListener(new JoyStickOnTouchListener());

        /* Position button click event handling */
        ...
        /* History button click event handling */
        ...
        /* This is used to determine joystick type */
    ...
    private void initJoyStickMapView() {
        ...
        mSearchView.setOnSearchClickListener(v -> {
            ...
            // Special handling: let search box get focus to show input method
        ...
        mSearchView.setOnCloseListener(() -> {
            ...
            return false;       /* Must return false here, otherwise need to manually handle search box collapse */
        });
    ...
    private void initHistoryView() {
        ...
        mRecordListView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            // Note: need to refresh map after selecting position
        ...
        if (list.size() == 0) {
            ...
            try {
                SimpleAdapter simAdapt = new SimpleAdapter(
                        ...
                        new String[]{HistoryActivity.KEY_ID, HistoryActivity.KEY_LOCATION, HistoryActivity.KEY_TIME, HistoryActivity.KEY_LNG_LAT_WGS, HistoryActivity.KEY_LNG_LAT_CUSTOM}, // Must correspond one-to-one with the array elements below
