...
public class JoyStick extends View {
    private static final int DivGo = 1000;    /* Movement interval time, unit: ms */
    ...
    private void initWindowManager() {
        ...
        mWindowParamCurrent.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE      // Not adding this will cause the game to fail to start (MIUI12), adding it will cause the keyboard to not display
    ...
    private void initJoyStickView() {
        ...
        mTimer.setListener(new GoUtils.TimeCount.TimeCountListener() {
            ...
            public void onFinish() {
                // Note: correspondence between x y and angle in circle (0 degrees is positive X-axis direction) and convert to km
