...
public class MainActivity extends BaseActivity implements SensorEventListener {
    ...
    private float[] mMagValues = new float[3];// Magnetic sensor data
    private final float[] mR = new float[9];// Rotation matrix, used to save magnetic field and acceleration data
        ...
        if (!hasHistory) {
            mLocationOverlay.runOnFirstFix(() -> runOnUiThread(() -> {
                ...
                if (myLoc != null) {
                    ...
                    GoUtils.DisplayToast(MainActivity.this, "Successfully got current location");
                }
            }));
        }
    }
    ...
    private void resetMap() {
        if (mLocationOverlay.getMyLocation() != null) {
            ...
            if (!GoUtils.isGpsOpened(this)) {
                ...
                GoUtils.DisplayToast(this, "Location failed: Please make sure you are outdoors in an open area and try again later");
            }
        }
    }
    ...
    private void doGoLocation(View v) {
        ...
        if (isMockServStart) {
            if (mMarkLatLngMap == null) {
                stopGoLocation();
                Snackbar.make(v, "Location simulation stopped", Snackbar.LENGTH_LONG)
                ...
                Snackbar.make(v, "Teleported to new location", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
            ...
            if (!GoUtils.isAllowMockLocation(this)) {
                ...
                if (mMarkLatLngMap == null) {
                    Snackbar.make(v, "Please click a map location or search for a location first", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                } else {
                    startGoLocation();
                    mButtonStart.setImageResource(R.drawable.ic_fly);
                    Snackbar.make(v, "Location simulation started", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
