...
public class HideMockHook implements IXposedHookLoadPackage {
    ...
    // Whitelist: Exclude self and system core processes to avoid accidental impact
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        try {
            ...
            // 3. Actively fake satellite status (GnssStatus Only)
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                // 2.1 Intercept unregistration (prevent memory leaks)
            ...
            // 4. Clean up Settings and Provider list
