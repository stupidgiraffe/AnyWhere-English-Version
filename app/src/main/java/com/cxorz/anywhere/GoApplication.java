    ...
    private void initXlog() {
        ...
        if (logPath != null) {
            LogConfiguration config = new LogConfiguration.Builder()
                    ...
                    .enableThreadInfo()                                    // Allow printing thread info, disabled by default
                    .enableStackTrace(2)                                   // Allow printing stack trace with depth 2, disabled by default
                    .enableBorder()                                        // Allow printing log borders, disabled by default
                    .build();
            ...
            Printer filePrinter = new FilePrinter                           // Printer that prints logs to file
                    .Builder(logPath.getPath())                             // Specify the path to save log files
